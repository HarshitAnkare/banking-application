...
class BankingApp:
    def __init__(self, root):
        ...
        # Create buttons
        self.create_account_button = tk.Button(root, font=25,width=25,height=2, text="Create Account",fg="black",bg="yellow", command=self.create_account)
        self.create_account_button.pack(pady=(30,5))

        self.deposit_button = tk.Button(root, font=25,width=20,height=2, text="Deposit", command=self.deposit,fg="black",bg="yellow", state=tk.DISABLED)
        self.deposit_button.pack(pady=5)

        self.withdraw_button = tk.Button(root, font=25,width=20,height=2, text="Withdraw", command=self.withdraw,fg="black",bg="yellow", state=tk.DISABLED)
        self.withdraw_button.pack(pady=5)

        self.check_balance_button = tk.Button(root, text="Check Balance", font=25,width=25,height=2, command=self.check_balance,fg="black",bg="yellow", state=tk.DISABLED)
